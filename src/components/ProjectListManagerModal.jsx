                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                  ...
                  <Field label="LMs">
                    <NumericField
                      kind="int"
                      min={0}
                      value={Number.isFinite(+draft.totalLMs) ? +draft.totalLMs : 0}
                      onCommit={(v) => setDraft({ ...draft, totalLMs: v ?? 0 })}
                      style={inputStyle}
                    />
                  </Field>
                  <Field label="LM multiplier">
                    <NumericField
                      kind="float"
                      min={0}
                      value={Number.isFinite(+draft.lmMultiplier) ? +draft.lmMultiplier : 1}
                      onCommit={(v) => setDraft({ ...draft, lmMultiplier: v ?? 1 })}
                      style={inputStyle}
                    />
                  </Field>
                  <div />
